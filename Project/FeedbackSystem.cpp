...
void FeedbackSystem::getFeedback(string name,string password)
{
    ...
    if(seat < 1 || seat > 25)
    {
        cout << "Enter Proper Seat Number!" << endl;
        system("PAUSE");
        goto again;
    ...
    {
        cout<<"You are being escorted back to the previous menu!"<<endl;
        pause;
        return;
    }
    ...
    {
        cout << "Sorry! Your time to use this feature has ended or may habe not started. Register a seat at current time to avail this feature\n";
        system("PAUSE");
    }
...
float FeedbackSystem::viewFeedback()
{
    ...
    do{
        ...
        cout << left << setw(3)<<setfill(' ') << c << ". "  << "Name : " << left << setw(32)<<setfill(' ')  << name /*<< setw(25) << setfill(' ')*/ << "Seat : " << left<<setfill(' ')  << setw(25) << seat /*<< setw(25) << setfill(' ')*/ << "Appliance : " << left << setw(46)<<setfill(' ')  << Problem << "Price : " << amount << endl;
